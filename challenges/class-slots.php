<?php
    ...
    class SlotMachine {
        ...
        public array $symbols = ['A', 'C', 'B', 'D', '7', '9'];
            ...
            switch ($options) {
                case 1:
                    ...
                    while ($tokens > 0) {
                        ...
                        $x = $this -> symbols[array_rand($this -> symbols)];
                        $x2 = $this -> symbols[array_rand($this -> symbols)];
                        $x3 = $this -> symbols[array_rand($this -> symbols)];
                        $x4 = $this -> symbols[array_rand($this -> symbols)];
                        $x5 = $this -> symbols[array_rand($this -> symbols)];
                        $x6 = $this -> symbols[array_rand($this -> symbols)];
                        $x7 = $this -> symbols[array_rand($this -> symbols)];
                        $x8 = $this -> symbols[array_rand($this -> symbols)];
                        $x9 = $this -> symbols[array_rand($this -> symbols)];
                ...
                case 2:
                    ...
                    while ($sum > 0) {
                        ...
                        $y = $this -> symbols[array_rand($this -> symbols)];
                        $y2 = $this -> symbols[array_rand($this -> symbols)];
                        $y3 = $this -> symbols[array_rand($this -> symbols)];
                        $y4 = $this -> symbols[array_rand($this -> symbols)];
                        $y5 = $this -> symbols[array_rand($this -> symbols)];
                        $y6 = $this -> symbols[array_rand($this -> symbols)];
                        $y7 = $this -> symbols[array_rand($this -> symbols)];
                        $y8 = $this -> symbols[array_rand($this -> symbols)];
                        $y9 = $this -> symbols[array_rand($this -> symbols)];
                        $y10 = $this -> symbols[array_rand($this -> symbols)];
                        $y11 = $this -> symbols[array_rand($this -> symbols)];
                        $y12 = $this -> symbols[array_rand($this -> symbols)];
